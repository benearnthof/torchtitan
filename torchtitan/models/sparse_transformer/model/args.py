"""
args.py
Inherit BaseModelArgs and implement the interfaces.
...
@dataclass
class ImageTransformerArgs(BaseModelArgs):
    dim: int = 256
    n_layers: int = 16
    n_heads: int = 2
    ...
    ffn_dim_multiplier: float | None = 2
    norm_eps: float = 1e-5
    ...
    # eos_id: int = None # eos_id used for blcok causal mask
